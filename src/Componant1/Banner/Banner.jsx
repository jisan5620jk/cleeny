...
const Banner = () => {
  return (
    <section className="bg-[url('/public/images/hero-bg.png')] bg-cover bg-center bg-no-repeat h-[814px] flex items-center">
      <div className="Container">
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center">
          ...
          <div className="relative">
            <div className="bg-[url('/public/images/hero-shape3.png')] bg-no-repeat bg-contain bg-right h-[130px] w-[205px] flex flex-col items-center justify-center gap-1 absolute -left-[6rem] -top-[2rem]">
              <TypeAnimation
