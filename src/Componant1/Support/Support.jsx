...
const Support = () => {
  return (
    <div className="Container">
      <div className="grid grid-cols-2 items-center bg-[url('/public/images/address-bg.png')] bg-cover bg-center bg-no-repeat py-[60px] px-16 rounded-md relative">
        <img src={supportShape}  className="absolute bottom-0 w-[inherit] h-[inherit] left-1/2"/>
        <div>
