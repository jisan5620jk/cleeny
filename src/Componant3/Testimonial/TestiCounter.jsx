...
const TestiCounter = ({counterIcon,counterPrice,counterDesc}) => {
    return (
      <div className="flex items-center gap-4 2xl:gap-6 px-6 2xl:px-[30px] py-7 rounded-md relative z-10 before:absolute before:top-0 before:left-0 before:w-full before:h-full before:rounded-md before:border before:border-dashed before:border-SecondaryColor-0">
