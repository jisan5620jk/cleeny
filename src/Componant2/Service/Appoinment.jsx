...
const Appoinment = () => {
    return (
      <div className="Container">
        ...
        <form action="#" method="post" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-7 items-center mt-14">
          <input
            type="text"
            name="name"
            id="name"
